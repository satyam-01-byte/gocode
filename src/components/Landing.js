...
const Landing = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-row items-start px-4 py-4 flex-wrap lg:flex-nowrap">
        <div className="flex flex-col lg:w-3/4 w-full h-full justify-start items-end mx-2 mb-6">
          <CodeEditorWindow
            code={code}
            onChange={onChange}
        ...
        <div className="right-container flex flex-shrink-0 lg:w-1/4 w-full flex-col mx-2">
